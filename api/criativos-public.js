...
const FUNIS_OBJETIVO = {
  ...
  whatsapp: { label: 'Funil de Mensagem no WhatsApp', objetivo: 'Levar a pessoa a INICIAR UMA CONVERSA no WhatsApp com o negócio. O clique no anúncio abre direto a conversa (click-to-WhatsApp) ou cai numa página cheia de botões que levam ao WhatsApp; nunca formulário, nunca pedido de e-mail. O CTA é "chamar no WhatsApp", "mandar mensagem", "falar com a gente agora". A venda acontece na conversa, não no anúncio: dê o motivo imediato pra mandar a mensagem (tirar dúvida, pedir orçamento, consultar preço ou disponibilidade, agendar horário) e deixe claro que tem gente respondendo rápido. Sugira a primeira mensagem que a pessoa vai enviar. Perfeito pra negócio local: cite bairro, cidade ou região e a facilidade de resolver tudo por mensagem.' },
