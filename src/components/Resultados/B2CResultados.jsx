...
import { Plus, Edit2, Check, X, Link2, Copy, CheckCircle2 } from 'lucide-react'
...
// ─── B2C Week Form ─────────────────────────────────────────────────────────────
function B2CWeekForm({ initial = {}, onSave, onCancel }) {
  const [form, setForm] = useState({
    investido:   initial.investido   != null ? String(initial.investido).replace('.', ',')   : '',
    leads:       initial.leads       || '',
    valorVendas: initial.valorVendas != null ? String(initial.valorVendas).replace('.', ',') : '',
