...
function assembleProject(row, rel = {}) {
  ...
  return {
    ...
    clickupFolderId:      row.clickup_folder_id || null,
    clickupListId:        row.clickup_list_id || null,
    clickupListUrl:       row.clickup_list_url || null,
    clickupChatChannelId: row.clickup_chat_channel_id || null,
...
const PROJECT_FIELD_MAP = {
  ...
  clickupListUrl:      "clickup_list_url",
  clickupChatChannelId: "clickup_chat_channel_id",
  clickup_folder_id:   "clickup_folder_id",
  clickup_list_id:     "clickup_list_id",
  clickup_list_url:    "clickup_list_url",
  clickup_chat_channel_id: "clickup_chat_channel_id",
